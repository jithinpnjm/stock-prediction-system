...
def add_historical_intraday_context(
    ...
    return out.with_columns(
        pl.Series("f_historical_slot_return_mean", values).fill_nan(None),
        pl.Series("f_historical_slot_return_std", stds).fill_nan(None),
        pl.Series("f_historical_slot_up_rate", rates).fill_nan(None),
    )
